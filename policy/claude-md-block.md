...
| Judgment: independent review / design / complex research | general-purpose | **explicit opus** | inherit session |
...
- Split the judgment tier: light judgment (single-file review, copy review, two-way choices, small verifiable research) → tag sonnet; heavy judgment (architecture, cross-file review, open-ended design, multi-source synthesis) → tag opus; unsure → opus, and say which tier you used when reporting.
